 ...
 * It can returns/removes a randomly selected word from its dictionary.
 * 
...
public class WordPicker {
	...
	// Number of words picked from each bag in the simulation, i.e. N.
	final static int PICKS = 20;
	...
	{	
		...
		switch(bagType) {
		case 1 : words = new MagicalBag1<String>();
				 break;
		case 2 : words = new MagicalBag2<String>();
		 		 break;
		case 3 : words = new MagicalBag3<String>();
		 		 break;
		case 4 : words = new MagicalBag4<String>();
		 		 break;		 		 
		case 5 : words = new MagicalBag5<String>();
		 		 break;		 		 
		case 6 : words = new MagicalBag6<String>();
		 		 break;		 		 
	...
	public static String simulation(String dictionaryFile, int bagType) 
	{
		...
		try {
			...
			results += String.format("\nTime taken to build the dictionary: %.4fs\n", 
							(ends - starts)/1000.0);
			...
			results += String.format("\n\n>> Time taken to pick the above words: %.4fs\n\n", 
							(ends - starts)/1000.0);
			...
			results += String.format("\n\n>> Time taken to remove the above words: %.4fs\n\n",
							(ends - starts)/1000.0);
		} 
